...
primary_expression
	: IDENTIFIER              {
                                    $$=make_parent(primary_expression_type, $1, 0);
                                    printf("primary_expression: IDENTIFIER\n");
                                  }
	| constant                {
                                    $$=make_parent(primary_expression_type, $1, 1);
                                    printf("primary_expression: constant\n");
                                  }
	| string                  {
                                    $$=make_parent(primary_expression_type, $1, 2);
                                    printf("primary_expression: string\n");
                                  }
	| '(' expression ')'      {
                                    $$=make_parent(primary_expression_type, $2, 3);
                                    printf("primary_expression: '(' expression ')'\n");
                                  }
	| generic_selection       {
                                    $$=make_parent(primary_expression_type, $1, 4);
...
constant
	: I_CONSTANT	           {
                                     $$=make_parent(constant_type, $1, 0);
                                     printf("constant: I_CONSTANT\n");
                                   }	/* includes character_constant */
	| F_CONSTANT               {
                                     $$=make_parent(constant_type, $1, 1);
                                     printf("constant: F_CONSTANT\n");
                                   }
	| ENUMERATION_CONSTANT	   {
                                     $$=make_parent(constant_type, $1, 2);
...
enumeration_constant		/* before it has been defined as such */
	: IDENTIFIER               {
                                     $$=make_parent(enumeration_constant_type, $1, 0); 
...
string
	: STRING_LITERAL      {
                                $$=make_parent(string_type, $1, 0);
                                printf("string: STRING_LITERAL\n");
                              }
	| FUNC_NAME           {
                                $$=make_parent(string_type, 0x00, 1);
...
generic_selection
	: GENERIC '(' assignment_expression ',' generic_assoc_list ')'  {
                                                                          $$=make_parent(generic_selection_type, $3, 0);
                                                                          make_brother($3, $5);
...
generic_assoc_list
	: generic_association                            {
                                                           $$=make_parent(generic_assoc_list_type, $1, 0);
...
generic_association
	: type_name ':' assignment_expression    {
                                                   $$=make_parent(generic_association_type, $1, 0);
                                                   make_brother($1, $3);
                                                   printf("generic_association: type_name ':' assignment_expression\n");
                                                 }
	| DEFAULT ':' assignment_expression      {
                                                   $$=make_parent(generic_association_type, $3, 1);
...
postfix_expression
	: primary_expression                                   {
                                                                 $$=make_parent(postfix_expression_type, $1, 0);
                                                                 printf("postfix_expression: primary_expression\n");
                                                               }
	| postfix_expression '[' expression ']'                {
                                                                 $$=make_parent(postfix_expression_type, $1, 1);
                                                                 make_brother($1, $3);
                                                                 printf("postfix_expression: postfix_expression '[' expression ']'\n");
                                                               }
	| postfix_expression '(' ')'                           {
                                                                 $$=make_parent(postfix_expression_type, $1, 2);
                                                                 printf("postfix_expression: postfix_expression '(' ')'\n");
                                                               }
	| postfix_expression '(' argument_expression_list ')'  {
                                                                 $$=make_parent(postfix_expression_type, $1, 3);
                                                                 make_brother($1, $3);
                                                                 printf("postfix_expression: postfix_expression '(' argument_expression_list')'\n");
                                                               }
	| postfix_expression '.' IDENTIFIER                    {
                                                                 $$=make_parent(postfix_expression_type, $1, 4);
                                                                 make_brother($1, $3);
                                                                 printf("postfix_expression: postfix_expression '.' IDENTIFIER\n");
                                                               }
	| postfix_expression PTR_OP IDENTIFIER                 {
                                                                 $$=make_parent(postfix_expression_type, $1, 5);
                                                                 make_brother($1, $3);
                                                                 printf("postfix_expression: postfix_expression PTR_OP IDENTIFIER\n");
                                                               }
	| postfix_expression INC_OP                            {
                                                                 $$=make_parent(postfix_expression_type, $1, 6);
                                                                 printf("postfix_expression: postfix_expression INC_OP\n");
                                                               }
	| postfix_expression DEC_OP                            {
                                                                 $$=make_parent(postfix_expression_type, $1, 7);
                                                                 printf("postfix_expression: postfix_expression DEC_OP\n");
                                                               }
	| '(' type_name ')' '{' initializer_list '}'           {
                                                                 $$=make_parent(postfix_expression_type, $2, 8);
                                                                 make_brother($2, $5);
                                                                 printf("postfix_expression: '(' type_name ')' '{' initializer_list '}'\n");
                                                               }
	| '(' type_name ')' '{' initializer_list ',' '}'       {
                                                                 $$=make_parent(postfix_expression_type, $2, 9);
                                                                 make_brother($2, $5);
                                                                 printf("postfix_expression: '(' type_name ')' '{' initializer_list ',' '}'\n");
                                                               }
	;
...
argument_expression_list
	: assignment_expression                                          {
                                                                           $$=make_parent(argument_expression_list_type, $1, 0);
...
unary_expression
	: postfix_expression                  {
                                                $$=make_parent(unary_expression_type, $1, 0);
                                                printf("unary_expression: postfix_expression\n");
                                              }
	| INC_OP unary_expression             {
                                                $$=make_parent(unary_expression_type, $2, 1);
                                                printf("unary_expression: INC_OP unary_expression\n");
                                              }
	| DEC_OP unary_expression             {
                                                $$=make_parent(unary_expression_type, $2, 2);
                                                printf("unary_expression: DEC_OP unary_expression\n");
                                              }
	| unary_operator cast_expression      {
                                                $$=make_parent(unary_expression_type, $1, 3);
                                                make_brother($1, $2);
                                                printf("unary_expression: unary_operator cast_expression\n");
                                              }
	| SIZEOF unary_expression             {
                                                $$=make_parent(unary_expression_type, $2, 4);
                                                printf("unary_expression: SIZEOF unary_expression\n");
                                              }
	| SIZEOF '(' type_name ')'            {
                                                $$=make_parent(unary_expression_type, $3, 5);
                                                printf("unary_expression: SIZEOF '(' type_name ')'\n");
                                              }
	| ALIGNOF '(' type_name ')'           {
                                                $$=make_parent(unary_expression_type, $3, 6);
...
unary_operator
	: '&'             {
                            $$=make_parent(unary_operator_type, 0x00, 0);
                            printf("unary_operator: '&'\n");
                          }
	| '*'             {
                            $$=make_parent(unary_operator_type, 0x00, 1);
                            printf("unary_operator: '*'\n");
                          }
	| '+'             {
                            $$=make_parent(unary_operator_type, 0x00, 2);
                            printf("unary_operator: '+'\n");
                          }
	| '-'             {
                            $$=make_parent(unary_operator_type, 0x00, 3);
                            printf("unary_operator: '-'\n");
                          }
	| '~'             {
                            $$=make_parent(unary_operator_type, 0x00, 4);
                            printf("unary_operator: '~'\n");
                          }
	| '!'             {
                            $$=make_parent(unary_operator_type, 0x00, 5);
                            printf("unary_operator: '!'\n");
                          }
	;
...
cast_expression
	: unary_expression                        {
                                                    $$=make_parent(cast_expression_type, $1, 0);
                                                    printf("cast_expression: unary_expression\n");
                                                  }
	| '(' type_name ')' cast_expression       {
                                                    $$=make_parent(cast_expression_type, $2, 1);
                                                    make_brother($2, $4);
...
multiplicative_expression
	: cast_expression                                      {
                                                                 $$=make_parent(multiplicative_expression_type, $1, 0);
                                                                 printf("multiplicative_expression: cast_expression\n");
                                                               }
	| multiplicative_expression '*' cast_expression        {
                                                                 $$=make_parent(multiplicative_expression_type, $1, 1);
                                                                 make_brother($1, $3);
                                                                 printf("multiplicative_expression: multiplicative_expression '*' cast_expression\n");
                                                               }
	| multiplicative_expression '/' cast_expression        {
                                                                 $$=make_parent(multiplicative_expression_type, $1, 2);
                                                                 make_brother($1, $3);
                                                                 printf("multiplicative_expression: multiplicative_expression '/' cast_expression\n");
                                                               }
	| multiplicative_expression '%' cast_expression        {
                                                                 $$=make_parent(multiplicative_expression_type, $1, 3);
                                                                 make_brother($1, $3);
...
additive_expression
	: multiplicative_expression                          {
                                                               $$=make_parent(additive_expression_type, $1, 0);
                                                               printf("additive_expression: multiplicative_expression\n");
                                                             }
	| additive_expression '+' multiplicative_expression  {
                                                               $$=make_parent(additive_expression_type, $1, 1);
                                                               make_brother($1, $3);
                                                               printf("additive_expression: additive_expression '+' multiplicative_expression\n");
                                                             }
	| additive_expression '-' multiplicative_expression  {
                                                               $$=make_parent(additive_expression_type, $1, 2);
                                                               make_brother($1, $3);
                                                               printf("additive_expression: additive_expression '-' multiplicative_expression\n");
                                                             }
	;
...
shift_expression
	: additive_expression                            {
                                                           $$=make_parent(shift_expression_type, $1, 0);
                                                           printf("shift_expression: additive_expression\n");
                                                         }
	| shift_expression LEFT_OP additive_expression   {
                                                           $$=make_parent(shift_expression_type, $1, 1);
                                                           make_brother($1, $3);      
                                                           printf("shift_expression: shift_expression LEFT_OP additive_expression\n");
                                                         }
	| shift_expression RIGHT_OP additive_expression  {
                                                           $$=make_parent(shift_expression_type, $1, 2);
                                                           make_brother($1, $3);
...
relational_expression
	: shift_expression                             {
                                                         $$=make_parent(relational_expression_type, $1, 0);
                                                         printf("relational_expression: shift_expression\n");
                                                       }
	| relational_expression '<' shift_expression   {
                                                         $$=make_parent(relational_expression_type, $1, 1);
                                                         make_brother($1, $3);
                                                         printf("relational_expression: relational_expression '<' shift_expression\n");
                                                       }
	| relational_expression '>' shift_expression   {
                                                         $$=make_parent(relational_expression_type, $1, 2);
                                                         make_brother($1, $3);
                                                         printf("relational_expression: relational_expression '>' shift_expression\n");
                                                       }
	| relational_expression LE_OP shift_expression {
                                                         $$=make_parent(relational_expression_type, $1, 3);
                                                         make_brother($1, $3);
                                                         printf("relational_expression: relational_expression LE_OP shift_expression\n");
                                                       }
	| relational_expression GE_OP shift_expression {
                                                         $$=make_parent(relational_expression_type, $1, 4);
                                                         make_brother($1, $3);
...
equality_expression
	: relational_expression                            {
                                                             $$=make_parent(equality_expression_type, $1, 0);
                                                             printf("equality_expression: relational_expression\n");
                                                           }
	| equality_expression EQ_OP relational_expression  {
                                                             $$=make_parent(equality_expression_type, $1, 1);
                                                             make_brother($1, $3);
                                                             printf("equality_expression: equality_expression EQ_OP relational_expression\n");
                                                           }
	| equality_expression NE_OP relational_expression  {
                                                             $$=make_parent(equality_expression_type, $1, 2);
                                                             make_brother($1, $3);
...
and_expression
	: equality_expression                     {
                                                    $$=make_parent(and_expression_type, $1, 0);
                                                    printf("and_expression: equality_expression\n");
                                                  }
	| and_expression '&' equality_expression  {
                                                    $$=make_parent(and_expression_type, $1, 1);
                                                    make_brother($1, $3);
...
exclusive_or_expression
	: and_expression                              {
                                                        $$=make_parent(exclusive_or_expression_type, $1, 0);
                                                        printf("exclusive_or_expression: and_expression\n");
                                                      }
	| exclusive_or_expression '^' and_expression  {
                                                        $$=make_parent(exclusive_or_expression_type, $1, 1);
                                                        make_brother($1, $3);
...
inclusive_or_expression
	: exclusive_or_expression                              {
                                                                 $$=make_parent(inclusive_or_expression_type, $1, 0);
                                                                 printf("inclusive_or_expression: exclusive_or_expression\n");
                                                               }
	| inclusive_or_expression '|' exclusive_or_expression  {
                                                                 $$=make_parent(inclusive_or_expression_type, $1, 1);  
                                                                 make_brother($1, $3);
...
logical_and_expression
	: inclusive_or_expression                               {
                                                                  $$=make_parent(logical_and_expression_type, $1, 0);
                                                                  printf("logical_and_expression: inclusive_or_expression\n");
                                                                }
	| logical_and_expression AND_OP inclusive_or_expression { 
                                                                  $$=make_parent(logical_and_expression_type, $1, 1);
                                                                  make_brother($1, $3);
...
logical_or_expression
	: logical_and_expression                                {
                                                                  $$=make_parent(logical_or_expression_type, $1, 0);
                                                                  printf("logical_or_expression: logical_and_expression\n");
                                                                }
	| logical_or_expression OR_OP logical_and_expression    {
                                                                  $$=make_parent(logical_or_expression_type, $1, 1);
                                                                  make_brother($1, $3);
...
conditional_expression
	: logical_or_expression                                           {
                                                                            $$=make_parent(conditional_expression_type, $1, 0);
                                                                            printf("conditional_expression: logical_or_expression\n");
                                                                          }
	| logical_or_expression '?' expression ':' conditional_expression {
                                                                            $$=make_parent(conditional_expression_type, $1, 1);
                                                                            make_brother($1, $3);
                                                                            make_brother($3, $5);
...
assignment_expression
	: conditional_expression                                      {
                                                                        $$=make_parent(assignment_expression_type, $1, 0);
                                                                        printf("assignment_expression: conditional_expression\n");
                                                                      }
	| unary_expression assignment_operator assignment_expression  {
                                                                        $$=make_parent(assignment_expression_type, $1, 1);
                                                                        make_brother($1, $2);
                                                                        make_brother($2, $3);
...
assignment_operator
	: '='             {
                            struct node_my *child_tmp=make_parent(EQU_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 0);
                            printf("assignment_operator: '='\n");
                          }
	| MUL_ASSIGN      {
                            struct node_my *child_tmp=make_parent(MUL_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 1);
                            printf("assignment_operator: MUL_ASSIGN\n");
                          }
	| DIV_ASSIGN      {
                            struct node_my *child_tmp=make_parent(DIV_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 2);
                            printf("assignment_operator: DIV_ASSIGN\n");
                          }            
	| MOD_ASSIGN      {
                            struct node_my *child_tmp=make_parent(MOD_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 3);
                            printf("assignment_operator: MOD_ASSIGN\n");
                          }
	| ADD_ASSIGN      {
                            struct node_my *child_tmp=make_parent(ADD_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 4);
                            printf("assignment_operator: ADD_ASSIGN\n");
                          }
	| SUB_ASSIGN      {
                            struct node_my *child_tmp=make_parent(SUB_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 5);
                            printf("assignment_operator: SUB_ASSIGN\n");
                          }
	| LEFT_ASSIGN     {
                            struct node_my *child_tmp=make_parent(LEFT_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 6);
                            printf("assignment_operator: LEFT_ASSIGN\n");
                          }
	| RIGHT_ASSIGN    {
                            struct node_my *child_tmp=make_parent(RIGHT_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 7);
                            printf("assignment_operator: RIGHT_ASSIGN\n");
                          }
	| AND_ASSIGN      {
                            struct node_my *child_tmp=make_parent(AND_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 8);
                            printf("assignment_operator: AND_ASSIGN\n");
                          }
	| XOR_ASSIGN      {
                            struct node_my *child_tmp=make_parent(XOR_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 9);
                            printf("assignment_operator: XOR_ASSIGN\n");
                          }
	| OR_ASSIGN       { 
                            struct node_my *child_tmp=make_parent(OR_ASSIGN_type, 0x00, -1);
                            $$=make_parent(assignment_operator_type, child_tmp, 10);
...
expression
	: assignment_expression                 {
                                                  $$=make_parent(expression_type, $1, 0);
...
constant_expression
	: conditional_expression	{
                                          $$=make_parent(constant_expression_type, $1, 0);
...
declaration
	...
	| static_assert_declaration                        {
                                                             $$=make_parent(declaration_type, $1, 2);
...
declaration_specifiers
	...
	| storage_class_specifier                        {
                                                           $$=make_parent(declaration_specifiers_type, $1, 1);
	...
	| type_specifier                                 {
                                                           $$=make_parent(declaration_specifiers_type, $1, 3);
	...
	| type_qualifier                                 {
                                                           $$=make_parent(declaration_specifiers_type, $1, 5);
	...
	| function_specifier                             {
                                                           $$=make_parent(declaration_specifiers_type, $1, 7);
	...
	| alignment_specifier                            {
                                                           $$=make_parent(declaration_specifiers_type, $1, 9);
...
init_declarator_list
	: init_declarator                           {
                                                      $$=make_parent(init_declarator_list_type, $1, 0);
...
init_declarator
	: declarator '=' initializer     {
                                           $$=make_parent(init_declarator_type, $1, 0);
                                           make_brother($1, $3);
                                           printf("init_declarator: declarator '=' initializer\n");
                                         }
	| declarator                     {
                                           $$=make_parent(init_declarator_type, $1, 1);
...
storage_class_specifier
	: TYPEDEF	 {
                           ...
                           $$=make_parent(storage_class_specifier_type, 0x00, 0);
...
struct_declaration_list
	: struct_declaration                          {
                                                        $$=make_parent(struct_declaration_list_type, $1, 0);
...
specifier_qualifier_list
	...
	| type_specifier                          {
                                                    $$=make_parent(specifier_qualifier_list_type, $1, 1);
	...
	| type_qualifier                          {
                                                    $$=make_parent(specifier_qualifier_list_type, $1, 3);
...
struct_declarator_list
	: struct_declarator                              {
                                                           $$=make_parent(struct_declarator_list_type, $1, 0);
...
struct_declarator
	: ':' constant_expression             {
                                                $$=make_parent(struct_declarator_type, $2, 0);
                                                printf("struct_declarator: ':' constant_expression\n");
                                              }
	| declarator ':' constant_expression  {
                                                $$=make_parent(struct_declarator_type, $1, 1);
                                                make_brother($1, $3);
                                                printf("struct_declarator: declarator ':' constant_expression\n");
                                              }
	| declarator                          {
                                                $$=make_parent(struct_declarator_type, $1, 2);
...
enum_specifier
	: ENUM '{' enumerator_list '}'                 {
                                                         $$=make_parent(enum_specifier_type, $3, 0);
                                                         node_symbol_type_to_ENUMERATION_CONSTANT_type($3);
                                                         printf("enum_specifier: ENUM '{' enumerator_list '}'\n");
                                                       }
	| ENUM '{' enumerator_list ',' '}'             {
                                                         $$=make_parent(enum_specifier_type, $3, 1);
                                                         node_symbol_type_to_ENUMERATION_CONSTANT_type($3);
                                                         printf("enum_specifier: ENUM '{' enumerator_list ',' '}'\n");
                                                       }
	| ENUM IDENTIFIER '{' enumerator_list '}'      {
                                                         $$=make_parent(enum_specifier_type, $2, 2);
                                                         make_brother($2, $4);
	...
	| ENUM IDENTIFIER '{' enumerator_list ',' '}'  {
                                                         $$=make_parent(enum_specifier_type, $2, 3);
                                                         make_brother($2, $4);
                                                         node_symbol_type_to_ENUMERATION_CONSTANT_type($4);
                                                         node_symbol_type_to_enum_type($2);
                                                         printf("enum_specifier: ENUM IDENTIFIER '{' enumerator_list ',' '}'\n");
	...
	| ENUM IDENTIFIER                              {
                                                         $$=make_parent(enum_specifier_type, $2, 4);
                                                         node_symbol_type_to_enum_type($2);
...
enumerator_list
	: enumerator                        {
                                              $$=make_parent(enumerator_list_type, $1, 0);
...
enumerator	/* identifiers must be flagged as ENUMERATION_CONSTANT */
	: enumeration_constant '=' constant_expression  {
                                                          $$=make_parent(enumerator_type, $1, 0);
                                                          make_brother($1, $3);
                                                          printf("enumerator: enumerator_constant '=' constant_expression\n");
                                                        }
	| enumeration_constant                          {
                                                          $$=make_parent(enumerator_type, $1, 1);
...
atomic_type_specifier
	: ATOMIC '(' type_name ')'             {
                                                 $$=make_parent(atomic_type_specifier_type, $3, 0);
...
alignment_specifier
	: ALIGNAS '(' type_name ')'             {
                                                  $$=make_parent(alignment_specifier_type, $3, 0);
                                                  printf("alignment_specifer: ALIGNAS '(' type_name ')'\n");
                                                }
	| ALIGNAS '(' constant_expression ')'   {
                                                  $$=make_parent(alignment_specifier_type, $3, 1);
...
declarator
	: pointer direct_declarator {
                                      $$=make_parent(declarator_type, $1, 0);
                                      make_brother($1, $2);
                                      printf("declarator: pointer direct_declarator\n");
                                    } 
	| direct_declarator         {
                                      $$=make_parent(declarator_type, $1, 1);
...
pointer
	: '*' type_qualifier_list pointer     {
                                                $$=make_parent(pointer_type, $2, 0);
                                                make_brother($2, $3);
                                                printf("pointer: '*' type_qualifier_list pointer\n");
                                              }
	| '*' type_qualifier_list             {
                                                $$=make_parent(pointer_type, $2, 1);
                                                printf("pointer: '*' type_qualifier_list\n");
                                              }
	| '*' pointer                         {
                                                $$=make_parent(pointer_type, $2, 2);
                                                printf("pointer: '*' pointer\n");
                                              }
	| '*'                                 {
                                                $$=make_parent(pointer_type, 0x00, 3);
                                                printf("pointer: '*'\n");
                                              }
	;
...
type_qualifier_list
	: type_qualifier                        {
                                                  $$=make_parent(type_qualifier_list_type, $1, 0);
...
parameter_type_list
	: parameter_list ',' ELLIPSIS      {
                                             $$=make_parent(parameter_type_list_type, $1, 0);
                                             //make_brother($1, $3);
                                             printf("parameter_type_list: parameter_list ',' ELLIPSIS\n");
                                           }
	| parameter_list                   {
                                             $$=make_parent(parameter_type_list_type, $1, 1);
...
parameter_list
	: parameter_declaration                      {
                                                       $$=make_parent(parameter_list_type, $1, 0);
...
parameter_declaration
	: declaration_specifiers declarator             {
                                                          $$=make_parent(parameter_declaration_type, $1, 0);
                                                          make_brother($1, $2);
                                                          printf("parameter_declaration: declaration_specifiers declarator\n");
                                                        }
	| declaration_specifiers abstract_declarator    {
                                                          $$=make_parent(parameter_declaration_type, $1, 1);
                                                          make_brother($1, $2);
                                                          printf("parameter_declaration: declaration_specifiers abstract_declarator\n");
                                                        }
	| declaration_specifiers                        {
                                                          $$=make_parent(parameter_declaration_type, $1, 2);
...
identifier_list
	: IDENTIFIER                       {
                                             $$=make_parent(identifier_list_type, $1, 0);
                                             printf("identifier_list: IDENTIFIER\n");
                                           }
	| identifier_list ',' IDENTIFIER   {
                                             $$=make_parent(identifier_list_type, $1, 1);
                                             make_brother($1, $3);
...
abstract_declarator
	: pointer direct_abstract_declarator     {
                                                   $$=make_parent(abstract_declarator_type, $1, 0);
                                                   make_brother($1, $2);
                                                   printf("abstract_declarator: pointer direct_abstract_declarator\n");
                                                 }
	| pointer                                {
                                                   $$=make_parent(abstract_declarator_type, $1, 1);
                                                   printf("abstract_declarator: pointer\n");
                                                 }
	| direct_abstract_declarator             {
                                                   $$=make_parent(abstract_declarator_type, $1, 2);
...
initializer
	: '{' initializer_list '}'       {
                                           $$=make_parent(initializer_type, $2, 0);
                                           printf("initializer: '{' initializer_list '}'\n");
                                         }
	| '{' initializer_list ',' '}'   {
                                           $$=make_parent(initializer_type, $2, 1);
                                           printf("initializer: '{' initializer_list ',' '}'\n");
                                         }
	| assignment_expression          {
                                           $$=make_parent(initializer_type, $1, 2);
...
initializer_list
	: designation initializer     {
                                        $$=make_parent(initializer_list_type, $1, 0);
                                        make_brother($1, $2);
                                        printf("initializer_list: designation initializer\n");
                                      }
	| initializer                 {
                                        $$=make_parent(initializer_list_type, $1, 1);
...
designation
	: designator_list '='             {
                                            $$=make_parent(designation_type, $1, 0);
...
designator_list
	: designator                        {
                                              $$=make_parent(designator_list_type, $1, 0);
...
designator
	: '[' constant_expression ']'  {
                                         $$=make_parent(designator_type, $2, 0);
                                         printf("designator: '[' constant_expression ']'\n");
                                       }
	| '.' IDENTIFIER               {
                                         $$=make_parent(designator_type, $2, 1);
...
static_assert_declaration
	: STATIC_ASSERT '(' constant_expression ',' STRING_LITERAL ')' ';' {
                                                                             $$=make_parent(static_assert_declaration_type, $3, 0);
                                                                             make_brother($3, $5);
...
statement
	: labeled_statement             {
                                          $$=make_parent(statement_type, $1, 0);
                                          printf("statement: labeled_statement\n");
                                        }
	| compound_statement            {
                                          $$=make_parent(statement_type, $1, 1);
                                          printf("statement: compound_statement\n");
                                        }
	| expression_statement          {
                                          $$=make_parent(statement_type, $1, 2);
                                          printf("statement: expression_statement\n");
                                        }
	| selection_statement           {
                                          $$=make_parent(statement_type, $1, 3);
                                          printf("statement: selection_statement\n");
                                        }
	| iteration_statement           {
                                          $$=make_parent(statement_type, $1, 4);
                                          printf("statement: iteration_statement\n");
                                        }
	| jump_statement                {
                                          $$=make_parent(statement_type, $1, 5);
...
labeled_statement
	: IDENTIFIER ':' statement                 {
                                                     $$=make_parent(labeled_statement_type, $1, 0);
                                                     make_brother($1, $3);
                                                     printf("labeled_statement: IDENTIFIER ':' statement\n");
                                                   }
	| CASE constant_expression ':' statement   {
                                                     $$=make_parent(labeled_statement_type, $2, 1);
                                                     make_brother($2, $4);
                                                     printf("labeled_statement: CASE constant_expression ':' statement\n");
                                                   }
	| DEFAULT ':' statement                    {
                                                     $$=make_parent(labeled_statement_type, $3, 2);
...
compound_statement
	: '{' '}'                      {
                                         $$=make_parent(compound_statement_type, 0x00, 0);
                                         give_compound_id($$);
                                         printf("compound_statement: '{' '}'\n");
                                       }
	| '{'  block_item_list '}'     {
                                         $$=make_parent(compound_statement_type, $2, 1);
                                         give_compound_id($$);
...
block_item_list
	: block_item                    {
                                          $$=make_parent(block_item_list_type, $1, 0);
...
block_item
	: declaration     {
                            $$=make_parent(block_item_type, $1, 0);
                            printf("block_item: declaration\n");
                          }
	| statement       {
                            $$=make_parent(block_item_type, $1, 1);
...
expression_statement
	: ';'                {
                               $$=make_parent(expression_statement_type, 0x00, 0);
                               printf("expression_statement: ';'\n");
                             }
	| expression ';'     {
                               $$=make_parent(expression_statement_type, $1, 1);
...
selection_statement
	: IF '(' expression ')' statement ELSE statement  {
                                                            $$=make_parent(selection_statement_type, $3, 0);
                                                            make_brother($3, $5);
                                                            make_brother($5, $7);
                                                            printf("selection_statement: IF '(' expression ')' statement ELSE statement\n");
                                                          }
	| IF '(' expression ')' statement                 {
                                                            $$=make_parent(selection_statement_type, $3, 1);
                                                            make_brother($3, $5);
                                                            printf("selection_statement: IF '(' expression ')' statement\n");
                                                          }
	| SWITCH '(' expression ')' statement             {
                                                            $$=make_parent(selection_statement_type, $3, 2);
                                                            make_brother($3, $5);
...
iteration_statement
	: WHILE '(' expression ')' statement             {
                                                           $$=make_parent(iteration_statement_type, $3, 0);
                                                           make_brother($3, $5);
                                                           printf("iteration_statement: WHILE '(' expression ')' statement\n");
                                                         }
	| DO statement WHILE '(' expression ')' ';'      {
                                                           $$=make_parent(iteration_statement_type, $2, 1);
                                                           make_brother($2, $5);
                                                           printf("iteration_statement: DO  statement WHILE '(' expression ')'\n");
                                                         }
	| FOR '(' expression_statement expression_statement ')' statement                {
                                                                                           $$=make_parent(iteration_statement_type, $3, 2);
                                                                                           make_brother($3, $4);
                                                                                           make_brother($4, $6);
                                                                                           printf("iteration_statement: FOR '(' expression_statement expression_statement ')' statement\n");
                                                                                         }
	| FOR '(' expression_statement expression_statement expression ')' statement     {
                                                                                           $$=make_parent(iteration_statement_type, $3, 3);
                                                                                           make_brother($3, $4);
                                                                                           make_brother($4, $5);
                                                                                           make_brother($5, $7);
	...
	| FOR '(' declaration expression_statement ')' statement             {
                                                                               $$=make_parent(iteration_statement_type, $3, 4);
                                                                               make_brother($3, $4);
                                                                               make_brother($4, $6);
...
jump_statement
	: GOTO IDENTIFIER ';'   {
                                  $$=make_parent(jump_statement_type, $2, 0);
                                  printf("jump_statement: GOTO IDENTIFIER ';'\n");
                                }
	| CONTINUE ';'          {
                                  $$=make_parent(jump_statement_type, 0x00, 1);
                                  printf("jump_statement: CONTINUE ';'\n");
                                }
	| BREAK ';'             {
                                  $$=make_parent(jump_statement_type, 0x00, 2);
                                  printf("jump_statement: BREAK ';'\n");
                                }
	| RETURN ';'            {
                                  $$=make_parent(jump_statement_type, 0x00, 3);
                                  printf("jump_statement: RETURN ';'\n");
                                }
	| RETURN expression ';' {
                                  $$=make_parent(jump_statement_type, $2, 4);
...
translation_unit
	: external_declaration                   {
                                                   ...
                                                   $$=make_parent(translation_unit_type, $1, 0);
...
external_declaration
	: function_definition     {
                                    $$=make_parent(external_declaration_type, $1, 0);
                                    printf("cbison.y:1624 start\n");
                                    smbl_function_definition($1->node_index);
	...
	| declaration             {
                                    ...
                                    $$=make_parent(external_declaration_type, $1, 1);
                                    //external_declaration_table[external_declaration_number]=$$;
                                    //external_declaration_number+=1;
...
function_definition
	: declaration_specifiers declarator declaration_list compound_statement   {
                                                                                    $$=make_parent(function_definition_type, $1, 0);
                                                                                    make_brother($1, $2);
                                                                                    make_brother($2, $3);
                                                                                    make_brother($3, $4);
	...
	| declaration_specifiers declarator compound_statement                    {
                                                                                    ...
                                                                                    $$=make_parent(function_definition_type, $1, 1);
                                                                                    make_brother($1, $2);
                                                                                    make_brother($2, $3);
                                                                                    //smbl_function_definition(-1);
...
declaration_list
	: declaration                        {
                                               $$=make_parent(declaration_list_type, $1, 0);
